...
CUDA_VISIBLE_DEVICES=0 nohup python -u internvl25_small_devi.py \
    ...
    --model_size 2 \
    --data_mode train \
    >/work/gw42/w42010/msra/all_new_type/results/devis_vector/pope/logs/internvl25_2b.logs 2>&1 &


CUDA_VISIBLE_DEVICES=4 nohup python -u internvl25_small_devi.py \
    --read_dir /work/gw42/w42010/msra/all_new_type/data/pope/pope_ \
    --image_dir /work/gw42/w42010/msra/all_new_type/data/pope/pope_images \
    --vector_save_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/pope \
    --model_size 8 \
    --data_mode train \
    >/work/gw42/w42010/msra/all_new_type/results/devis_vector/pope/logs/internvl25_8b.logs 2>&1 &
