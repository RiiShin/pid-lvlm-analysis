...
CUDA_VISIBLE_DEVICES=0 nohup python -u small_embed.py \
    ...
    --num_choices 4 \
    --model_llava_size 0.5 \
    --data_mode train \
    --devi_vector_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/mmbench \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/mmbench/logs/llava_ov_0.5b_train.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=1 nohup python -u small_embed.py \
    ...
    --data_mode val \
    --devi_vector_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/mmbench \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/mmbench/logs/llava_ov_0.5b_val.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 nohup python -u small_embed.py \
    ...
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pope/logs/llava_ov_0.5b_train.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=4 nohup python -u small_embed.py \
    ...
    --data_mode val \
    --devi_vector_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/pope \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pope/logs/llava_ov_0.5b_val.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=6 nohup python -u small_embed.py \
    ...
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pmc/logs/llava_ov_0.5b_train.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=7 nohup python -u small_embed.py \
    ...
    --data_mode val \
    --devi_vector_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/pmc \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pmc/logs/llava_ov_0.5b_val.logs 2>&1 &
