...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -u llama_11b_embed.py \
    ...
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pope/logs/llama_11b_train.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=4,5,6,7 nohup python -u llama_11b_embed.py \
    ...
    --data_mode val \
    --devi_vector_dir /work/gw42/w42010/msra/all_new_type/results/devis_vector/pope \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pope/logs/llama_11b_val.logs 2>&1 &
