...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -u qwen2_72b_embed.py \
    ...
    --model_qwen_size 72 \
    --data_mode train \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pmc/logs/qwen2_72b_train.logs 2>&1 &
...
CUDA_VISIBLE_DEVICES=4,5,6,7 nohup python -u qwen2_72b_embed.py \
    ...
    --model_qwen_size 72 \
    --data_mode val \
    >/work/gw42/w42010/msra/all_new_type/results/embeds/pmc/logs/qwen2_72b_val.logs 2>&1 &
