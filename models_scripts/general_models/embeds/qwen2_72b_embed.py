...
parser.add_argument('--model_qwen_size', type=str, default=None, required=True, help='Size of the Qwen2 VL model (e.g., "2B", "7B").')
...
model_name = f"Qwen/Qwen2-VL-{model_qwen_size}B-Instruct"
# Construct save file name (moved after argument parsing)
save_json_name = f"/qwen2_{model_qwen_size}.json"
