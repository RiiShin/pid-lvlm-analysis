...
parser = argparse.ArgumentParser(description="Run InternVL2_5 model inference with specified parameters.")
...
save_json_name = f"/internvl25_{model_size}.json"
...
for item in tqdm(data):
    ...
    text_ind_1 = (input_ids[0] == 92545).nonzero(as_tuple=True)[0].item()
    text_ind_2 = (input_ids[0] == 92542).nonzero(as_tuple=True)[0][1].item()
